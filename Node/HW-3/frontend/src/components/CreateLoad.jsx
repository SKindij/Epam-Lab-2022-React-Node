...
export default function FormDialog({ openModal, handleClose, handleSubmit}) {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField required
                ...
                label='Pick-Up Address' fullWidth
            ...
            <Grid item xs={12}>
              <TextField required
                ...
                label='Delivery Address' fullWidth
            ...
            <Grid item xs={12} sm={12}>
              <TextField required
                id='standard-number' label='Weight'
            ...
            <Grid item xs={12} sm={4}>
              <TextField required
                id='standard-number' label='Width'
                type='number' fullWidth
                variant='standard'               
            ...
            <Grid item xs={12} sm={4}>
              <TextField required
                id='standard-number' label='Height'
                type='number' fullWidth
                variant='standard'              
            ...
            <Grid item xs={12} sm={4}>
              <TextField required
                id='standard-number' label='Length'
                type='number' fullWidth
                variant='standard'             
